                    ...
                    <FlexBox sx={ {
                        ...
                        <FlexBox sx={ {
                            ...
                            <Description variant="h6" component='span' sx={ {
                                ...
                                NFTs are not just jpegs. They give the ability to assign ownership of any unique piece
                                of digital data and can act as a professional certificate of authenticity. On
                                SpringRole, you get an NFT for every section you fill.
                            </Description>
                        </FlexBox>
                    </FlexBox>
                </Box>
