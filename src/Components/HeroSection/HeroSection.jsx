        ...
        <>
            <HeroContainer>
                ...
                <HeroDescription component={ motion.div }
                                 animate={ animate }
                                 initial={ { opacity : 0 , y : 60 } }>
                    SoulBound is a platform where professionals demonstrate their work, get verified, give tenable
                    endorsements, get into communities, and more - everything on the blockchain!
                </HeroDescription>

            </HeroContainer>
            <FlexBox sx={ {
                marginLeft : { md : '25rem' , sm : '-20rem' , xs : '-6rem' } ,
